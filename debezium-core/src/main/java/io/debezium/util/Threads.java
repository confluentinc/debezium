...
public class Threads {
     ...
     */
    public static void runWithTimeout(Class<? extends SourceConnector> componentClass, Runnable operation, Duration timeout, String componentName, String operationName)
            throws Exception {
