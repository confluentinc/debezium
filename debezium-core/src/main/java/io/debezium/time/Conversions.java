 ...
 * <p>
 * Note on the conversion failures below: the {@code obj} value being converted is raw customer
 * column data, so exception messages in this class report only its type, never the value itself.
 *
