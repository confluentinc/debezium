        ...
        recoverRecords(recovered -> {
            ...
            if (stopPoints.containsKey(srcDocument) && comparator.isAtOrBefore(recovered, stopPoints.get(srcDocument))) {
                ...
                if (!preferDdl && tableChanges != null && !tableChanges.isEmpty()) {
                    ...
                    boolean likelyFiltered = 
                        ddlUpper.startsWith("DROP TEMPORARY TABLE IF EXISTS") ||
                        ddlUpper.startsWith("SET STATEMENT") ||
                        ddlUpper.startsWith("INSERT INTO") && (ddlUpper.contains("RDS_HEARTBEAT") || ddlUpper.contains("RDS_SYSINFO") || ddlUpper.contains("RDS_MONITOR")) ||
