...
public interface Configuration {
    ...
    Pattern PASSWORD_PATTERN = Pattern.compile(".*secret$|.*password$|.*sasl\\.jaas\\.config$|.*basic\\.auth\\.user\\.info|.*registry\\.auth\\.client-secret|.*snapshot\\.select\\.statement\\.overrides\\.data\\.map",
