...
spec:
  class: io.debezium.connector.sqlserver.SqlServerConnector_V2 // <2>
  config:
...
----
{
    ...
    "config": {
        "connector.class": "io.debezium.connector.sqlserver.SqlServerConnector_V2", // <2>
        "database.hostname": "192.168.99.100", // <3>
        "database.port": "1433", // <4>
        "database.user": "sa", // <5>
...
|No default
|The name of the Java class for the connector. Always use a value of `io.debezium.connector.sqlserver.SqlServerConnector_V2` for the SQL Server connector.
