...
apiVersion: {KafkaConnectorApiVersion}
  ...
  spec:
    class: io.debezium.connector.postgresql.PostgresConnector_V2
    tasksMax: 1  // <2>
    config:  // <3>
...
----
{
  ...
  "config": {
    "connector.class": "io.debezium.connector.postgresql.PostgresConnector_V2", // <2>
...
|No default
|The name of the Java class for the connector. Always use a value of `io.debezium.connector.postgresql.PostgresConnector_V2` for the PostgreSQL connector.
