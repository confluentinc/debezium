...
----
  ...
  spec:
    class: io.debezium.connector.mysql.MySqlConnector_V2
    tasksMax: 1  // <2>
    config:  // <3>
...
----
{
    ...
    "config": {
        "connector.class": "io.debezium.connector.mysql.MySqlConnector_V2", // <2>
...
|No default
|The name of the Java class for the connector. Always specify  `io.debezium.connector.mysql.MySqlConnector_V2` for the MySQL connector.
