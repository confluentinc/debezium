...
class TimescaleDb229DatabaseIT extends AbstractAsyncEngineConnectorTest {
    ...
    void prepareDatabase() throws Exception {
        ...
        final ThreadNameContext threadNameContext = new ThreadNameContext(
                TestHelper.TEST_CONNECTOR_NAME, TestHelper.TEST_THREAD_NAME_PATTERN, TestHelper.TEST_TASK_ID);
        connection = new PostgresConnection(jdbcConfig.build(), TestHelper.CONNECTION_TEST, threadNameContext);
