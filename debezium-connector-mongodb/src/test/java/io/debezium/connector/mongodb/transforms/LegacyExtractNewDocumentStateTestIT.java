 ...
 */
public class LegacyExtractNewDocumentStateTestIT extends AbstractExtractNewDocumentStateTestIT {
    ...
    public void testEmptyArray() throws InterruptedException, IOException {
        ...
        assertThat(transformedInsert.valueSchema().field("empty_array")).isNotNull();
        assertThat(((Struct) transformedInsert.value()).get("empty_array")).isNull();
