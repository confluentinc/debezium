...
public class LogMinerDmlParser implements DmlParser {
    ...
    private LogMinerDmlEntry parseInsert(String sql, Table table) {
        try {
            ...
            // Do not append the redo SQL: it contains customer column values.
            throw new DmlParserException("Failed to parse insert DML", e);
        }
    }
    ...
    private LogMinerDmlEntry parseUpdate(String sql, Table table) {
        try {
            ...
            // Do not append the redo SQL: it contains customer column values.
            throw new DmlParserException("Failed to parse update DML", e);
        }
    }
    ...
    private LogMinerDmlEntry parseDelete(String sql, Table table) {
        try {
            ...
            // Do not append the redo SQL: it contains customer column values.
            throw new DmlParserException("Failed to parse delete DML", e);
        }
    }
