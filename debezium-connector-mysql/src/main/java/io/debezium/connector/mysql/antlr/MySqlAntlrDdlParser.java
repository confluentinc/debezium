...
public class MySqlAntlrDdlParser extends AntlrDdlParser<MySqlLexer, MySqlParser> {
    ...
    private static class DataTypeResolverHolder {
        private static final DataTypeResolver INSTANCE = createDataTypeResolver();

        private static DataTypeResolver createDataTypeResolver() {
    ...
    protected DataTypeResolver initializeDataTypeResolver() {
        return DataTypeResolverHolder.INSTANCE;
    }
