...
public class StreamingSourceIT extends BinlogStreamingSourceIT<MySqlConnector> implements MySqlCommon {
    ...
    public void shouldFailOnUnknownTlsProtocol() {
        ...
        assertEquals(
                "Connector configuration is not valid. Unable to connect: Specified list of TLS versions only contains non valid TLS protocols. " +
                        "Accepted values are TLSv1.2 and TLSv1.3. Caused by: Specified list of TLS versions only contains non valid TLS protocols. Accepted values are TLSv1.2 and TLSv1.3.",
