 ...
 */
public class MySqlConnectorV2Test {

    @Test
    public void shouldReturnConfigurationDefinition() {
        assertConfigDefIsValid(new MySqlConnector_V2(), MySqlConnectorConfig_V2.ALL_FIELDS);
    }
    ...
    protected static void assertConfigDefIsValid(Connector connector, io.debezium.config.Field.Set fields) {
        ...
        fields.forEach(expected -> {
            ...
            else if (!expected.equals(MySqlConnectorConfig_V2.SERVER_ID)) {
