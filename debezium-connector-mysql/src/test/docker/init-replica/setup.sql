...
SET @command = IF(@version REGEXP '^8\\.0\\.', "CHANGE MASTER TO MASTER_HOST='database-gtids', MASTER_PORT=3306, MASTER_USER='replicator', MASTER_PASSWORD = 'replpass', MASTER_AUTO_POSITION=1;", "CHANGE REPLICATION SOURCE TO SOURCE_HOST='database-gtids', SOURCE_PORT=3306, SOURCE_USER='replicator', SOURCE_PASSWORD = 'replpass', SOURCE_AUTO_POSITION=1, GET_SOURCE_PUBLIC_KEY=1;");
